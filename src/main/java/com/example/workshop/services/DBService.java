...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maira", "g.ferreiragoulart@gmail.com", "75032918371",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana", "gabrielferreiragoulart@hotmail.com", "09685799067",
				TipoCliente.PESSOAFISICA, pe.encode("543"));
