...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.select().apis(RequestHandlerSelectors.basePackage("com.example.workshop.resources"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("Spring Boot API",
				"This API intend to show my knowledge using Spring Boot framework and RESTful services.", "Version 1.0",
				"N/A", new Contact("Gabriel Goulart", "https://www.linkedin.com/in/gabrielgoulart/",
						"gabrielfegoulart@gmail.com"),
